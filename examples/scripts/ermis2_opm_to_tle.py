...
epochs = ["30 Mar 2026 11:14:48.948"]

states = [([4841.832341, 4621.071765, -1658.297778], [2.341915, 0.160093, 7.315325])]
...
for idx, (t, state) in enumerate(zip(epochs, states)):
    ...
    # ERMIS2: DragArea and DryMass from mission specification
